...
import 'package:planit/emptyConnect.dart';
    ...
    try {
      DocumentSnapshot snapshot = await _firestore
          ...
          .doc(widget.questionID
              .toString()) // Use questionID directly to get the specific question
          .get();
                                    ...
                                    child: ElevatedButton(
                                        onPressed: () async {
                                          ...
                                          if (nextQuestion.exists) {
                                            ...
                                            // You can show a dialog or redirect to another screen here
                                          }
                                        },
                                        child: Text("Next",
                                            textAlign: TextAlign.center,
